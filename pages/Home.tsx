    ...
    <div className="overflow-x-hidden">
        ...
        >
          {HERO_SLIDES.map((slide, index) => (
            <div key={index} className="relative min-w-full h-full">
              <img 
                src={slide.image} 
                alt="Lyndor Beauty & Wellness Salon Görünümü" 
      ...
      <section className="py-32 relative overflow-hidden bg-[#0f0f0f]">
        <div className="absolute inset-0 opacity-20 transform scale-105 hover:scale-110 transition-transform duration-10000">
          <img src="https://images.unsplash.com/photo-1544161515-4af6b1d46fd0?auto=format&fit=crop&q=80&w=1920" className="w-full h-full object-cover grayscale" alt="Lyndor Güzellik Salonu Atmosfer" loading="lazy" />
        </div>

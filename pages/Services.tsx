...
const Services: React.FC = () => {
  useEffect(() => {
    document.title = "Hizmetlerimiz | LYNDOR Güzellik Protokolleri";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Leke protokolü, anti-aging, kalıcı makyaj ve lazer epilasyon gibi profesyonel hizmetlerimizi keşfedin.");
    }
  }, []);

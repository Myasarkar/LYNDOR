...
const SSS: React.FC = () => {
  useEffect(() => {
    document.title = "S.S.S | LYNDOR Hakkında Merak Edilenler";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Lazer epilasyon, cilt bakımı ve diğer uygulamalarımız hakkında sıkça sorulan soruların yanıtları.");
    }
  }, []);
